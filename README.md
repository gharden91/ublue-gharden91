...
- [Microsoft Edge](./docs/edge.md) — native RPM in `/opt`; why `/opt` is a real directory.
...
- [Fonts / color emoji](./docs/fonts.md) — resolved: emoji tofu in Chromium apps was a stale per-user font cache.
